      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-16">
        <div className="grid md:grid-cols-12 gap-10">
          <div className="md:col-span-4">
            <p className="text-lg font-semibold text-brand-primary-dark">산뜻치과</p>
            <p className="text-sm text-brand-text-sub mt-2">Santteut Dental</p>
        ...
        <div className="mt-14 pt-6 border-t border-slate-200/70 flex flex-wrap items-center justify-between gap-4 text-xs text-brand-text-muted">
          <p>© 2026 산뜻치과. 컨셉 디자인 데모입니다.</p>
          <div className="flex gap-4">
            <a href="#" className="hover:text-brand-primary-dark">
              개인정보처리방침
            </a>
            <a href="#" className="hover:text-brand-primary-dark">
              이용약관
